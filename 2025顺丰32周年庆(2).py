...
if __name__ == '__main__':
    ...
    token = "https://mcs-mimp-web.sf-express.com/mcs-mimp/share/app/shareRedirect?sign=qUmcJfOFSkm6dM7Da/WL3apvYWNmbWCQjd5ifNoUXQzWieRLSCYjzbWyswuTHZ%2Bxha3dY%2BiQAbCC50edgk3Zf2zjcI2E9A2QsaUPJBgBiVtynBcvR379yG7A1gb8Y9LNzanCnHUUBNF0YDnXfr1ZLUkqFjIxDd4VFtYLlstjYyrOClqUcHNT9jmLTLoC//SGd7eb08sGryFcU2PC0vgc9iCr%2BMIyp8W6wr0lUqMUOIQcfGcpS1hWGZs0cqheBMBwoF2RT%2BcOhHlEb3kixo9FafA192LW3TO92f4gS1Ofe4akcKYxGuSZ%2BAfkEgbADvZf%2BCrXeLAiYExz2il/RwXduA%3D%3D&source=SFAPP&bizCode=619"
    tokens = token.split('\n')
    # print(tokens)
    if len(tokens) > 0:
        print(f"\n>>>>>>>>>>共获取到{len(tokens)}个账号<<<<<<<<<<")
